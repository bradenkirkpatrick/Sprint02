...
public class World {
    ...
    public void createWorld() {   
        String[] nation_names = {"Minions", "Robs Nation", "Braden Nation", "Sussy Impostors"};
    ...
    public void encounter(Integer person1postion, Integer person2postion){
        ...
        if (p1damage > 0 && p2damage > 0){
            ...
            p1damage =  Die.roll(person1LifePointsToUse);
            p2damage =  Die.roll(person2LifePointsToUse);
        } else if (p1damage <= 0 && p2damage <= 0){ 
            //cowards encounter: nothing happens
        } else if (p1damage > 0) {
            // person 1 is fighting and person 2 is running
            p1damage = Die.roll(person1LifePointsToUse)/2;
        } else {
            // person 2 is fighting and person 1 is running
            p2damage = Die.roll(person2LifePointsToUse)/2;
        }
